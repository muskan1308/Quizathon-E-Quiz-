...
public class AddCpp extends HttpServlet
{
...
public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException,IOException
{
	...
	pw.println("</table>");
	pw.println("<br><br><br>");
	pw.println("<center><a href='UpdateCpp'>BACK</a></center>");
	pw.println("</div>");  
    pw.println("</div>");  
    pw.println("</body>");  
    pw.println("</html>");  
...
try{
	...
	System.out.println("count of cpp ques is"+count);	
		
		
		String query2 = " insert into cppquestions(Question,a,b,c,d,cans) values(?,?,?,?,?,?) "; 
