...
public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException,IOException
{
	...
	pw.println("<font size='6' color='red'>Add Java Question</font>");
	pw.println("<center>");
	...
	pw.println("</form>");
	pw.println("</table>");
	pw.println("<center><a href='UpdateJava'>BACK</a></center>");
	pw.println("</div>");  
    pw.println("</div>");  
    pw.println("</body>");  
    pw.println("</html>");  
...
try{
	...
	String query1= "select count(*) from javaquestions ";
	...
	System.out.println("count of java ques is"+count);	
		
		
		String query2 = " insert into javaquestions(Question,a,b,c,d,cans) values(?,?,?,?,?,?) "; 
		...
		pw.println("<br><br><center><a href='UpdateJava'>Okay</a></center>");
		}
		else
