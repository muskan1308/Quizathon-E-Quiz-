...
pw.println("<div id='main'><div id='f1'> <font size='7' color='white'> Quizathon </font></div>");
 ...
 pw.println("<center>");
pw.println("<form action='ViewAllRecords'><input type='submit' class='b1' value='Manage Users'></form>");
pw.println("</center>");
pw.println("<center>");
pw.println("<form action='AdminRegistration'><input type='submit' class='b1' value='Manage Admins'></form>");
pw.println("</center>");
pw.println("<center>");
pw.println("<form action='ManageExam'><input type='submit' class='b1' value='Manage Exams'></form>");
pw.println("</center>");
pw.println("<br><br>");
pw.println("<center>");
pw.println("<form action='Logout'><input type='submit' class='b1' value='Log Out'></form>");
pw.println("</center>");
