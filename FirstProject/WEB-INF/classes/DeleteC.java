...
try{
	...
	String query1= "Delete from cquestions where Qno=?";
	PreparedStatement ps= con.prepareStatement(query1);
	ps.setInt(1,qno);
	int i= ps.executeUpdate();
	String query2="Alter table cquestions drop column Qno";
	PreparedStatement ps1= con.prepareStatement(query2);
	ps1.executeUpdate();
	String query3= "alter table cquestions add Qno int not null Auto_Increment primary key first";
