...
public class DeleteJava extends HttpServlet
{
	int qno;
...
try{
	...
	String query1= "Delete from javaquestions where Qno=?";
	PreparedStatement ps= con.prepareStatement(query1);
	ps.setInt(1,qno);
	int i= ps.executeUpdate();
	String query2="Alter table javaquestions drop column Qno";
	PreparedStatement ps1= con.prepareStatement(query2);
	ps1.executeUpdate();
	String query3= "alter table javaquestions add Qno int not null Auto_Increment primary key first";
