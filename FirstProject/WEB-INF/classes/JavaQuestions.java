...
public class JavaQuestions extends HttpServlet
	{
		...
		int correct,wrong,skip,flag=0;
		int qCount=1;
		String cans,userans,o1,o2,o3,o4,q;
	...
	String query1= "Select * from javaquestions where Qno=?";
	...
	if(rs.next()){
		...
		pw.println("<br>");
		pw.println("<br>");
		pw.println("<form action='JavaQuestions' method='post'>");
	...
	else if(rs.next()==false)
	{
		...
		session.setAttribute("javacorrect",correct);
		session.setAttribute("javaskip",skip);
		session.setAttribute("javawrong",wrong);
		System.out.println("java right are="+correct);
		
		System.out.println("end of java questions");
		res.setContentType("text/html");
		pw.println("<html>");
		pw.println("<head>");
		pw.println("<style>");
		...
		pw.println("<center>");
		pw.println("<b>You've reached the end of Java Questions</b></font>");
		pw.println("</center>");
		pw.println("<br>");
		pw.println("<br><br>");
		pw.println("<center>");
		pw.println("<form action='Resultjava' method='get'>");
		pw.println("<input type='submit' value='Go to Result Page' class='b1'>");
		pw.println("</form>");
		pw.println("</center>");
		pw.println("</div>");
		pw.println("</div>");
