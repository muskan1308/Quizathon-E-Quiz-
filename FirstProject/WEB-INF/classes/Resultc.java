...
public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException,IOException
{
	...
	HttpSession csession = req.getSession(false);
	Integer cc=(Integer)csession.getAttribute("ccorrect");
	Integer cw=(Integer)csession.getAttribute("cwrong");
	Integer cskipped =(Integer)csession.getAttribute("cskip");
	System.out.println("c corrrect in cresult are="+cc);
	int cmarks= cc*5;
	...
	pw.println("<tr><td> C </td> <td>"+cc+"</td><td>"+cw+"</td><td>"+cskipped+"</td><td>"+cmarks+"</td></tr>");
    pw.println("</table>");
	pw.println("</center>");
    pw.println("<br>");  
    pw.println("<br>");  
