...
public class Resultjava extends HttpServlet
{
...
public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException,IOException
{
	...
	Integer jc=(Integer)session.getAttribute("javacorrect");
	Integer jw=(Integer)session.getAttribute("javawrong");
	Integer skipped =(Integer)session.getAttribute("javaskip");
	System.out.println("java corrrect in jresult are="+jc);
	int jmarks= jc*5;
	...
	pw.println("<tr><td> Java </td> <td>"+jc+"</td><td>"+jw+"</td><td>"+skipped+"</td><td>"+jmarks+"</td></tr>");
    pw.println("</table>");
	pw.println("</center>");
    pw.println("<br>");  
    pw.println("<br>");  
