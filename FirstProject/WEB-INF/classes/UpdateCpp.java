...
public class UpdateCpp extends HttpServlet
{
	int qno;
...
public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException,IOException
{
	...
	String query1= "select * from cppquestions ";
	...
	pw.println("<div id='f1'> <font size='7' color='white'>Manage CPP Questions </font></div>");
	...
	pw.println("<tr><td>"+question+"</td><td>"+a+"</td><td>"+b+"</td><td>"+c+"</td><td>"+d+" </td><td>"+cans+"</td><td><a href='DeleteCpp?qno="+qno+"'>Delete</a></td></tr>");
	}
	pw.println("</table>");
	...
	pw.println("<center>");
	pw.println("<form action='AddCpp'><input type='submit' class='b1' value='Add Question'></form>");
	pw.println("</center>");
