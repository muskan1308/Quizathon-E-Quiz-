...
public class cquestions extends HttpServlet
	{
	...
	String query1= "Select * from cquestions where Qno=?";
	...
	if(rs.next())
	{
		...
		pw.println("<br>");
		pw.println("<br>");
		pw.println("<form action='cquestions' method='post'>");
	...
	{
		flag=1;		
		HttpSession csession= req.getSession();
		csession.setAttribute("cskip",skip);
		csession.setAttribute("ccorrect",correct);
		csession.setAttribute("cwrong",wrong);
		
		System.out.println("end of c questions");
		res.setContentType("text/html");
		pw.println("<html>");
		pw.println("<head>");
		pw.println("<style>");
		...
		pw.println("<center>");
		pw.println("<b>You've reached the end of C Questions</b></font>");
		pw.println("</center>");
		pw.println("<br><br>");
		pw.println("<br><br>");
		pw.println("<center>");
		pw.println("<form action='Resultc' method='get'>");
